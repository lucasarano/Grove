...
import { Plus, Key, CaretDown, GitBranch, UserCircle, SignOut, Lock, List } from '@phosphor-icons/react';
import { useConversation } from '../context/ConversationContext';
import { useAuth } from '../context/AuthContext';
import { MODELS } from '../services/claude';
import { hasAnthropicAccess, hasOpenaiAccess } from '../lib/providerKeys';

export default function Header({ onShowApiKey, onShowAuth, onToggleSidebar }) {
  ...
  const isBlocked = (m) => m.tier === 'blocked';
              ...
              {MODELS.map((m) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isBlocked(m) && (
                      <span style={{ display: 'flex', alignItems: 'center', gap: '0.25rem', fontSize: '0.75rem', color: 'var(--color-text-tertiary)', flexShrink: 0 }}>
                        <Lock size={11} />
                        Premium
                      </span>
                    )}
